...
<body class="bg-gray-900"<?php body_class(" text-gray-900"); ?>>

    <!-- Top Header -->
    <div class=" bg-[#161515] text-white py-4 md:mx-20 px-5 flex justify-between hidden md:flex">
    <div class="container text-[14px] flex flex-wrap justify-between items-center px-4">
        <ul class="flex flex-wrap gap-4 sm:gap-6 text-sm">
            <li class="flex items-center gap-2">
                <span class="text-[14px]"><?php echo get_theme_mod('header_top_warranty', '24/7 Support'); ?></span>
            ...
            <li class="flex items-center gap-2">
                <span class="text-[14px]"><?php echo get_theme_mod('header_top_fast_service', 'Fast & Secure'); ?></span>
            ...
            <li class="flex items-center gap-2">
                <span class="text-[14px]"><?php echo get_theme_mod('header-top-experience', 'Experience'); ?></span>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="flex items-center gap-2">
                <span class="text-[14px]"><?php echo get_theme_mod('header-top-feedback', 'Feedback'); ?></span>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div>
        <div class="container  md:flex  inline-block items-center px-4 gap-4">
